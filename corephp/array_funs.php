...
//Array Function: array_push(),array_pop(),array_shift(),array_unshift(),array_values(),array_unique(),array_count_values(),
//                array_merge(),array_merge_recursive(),array_combine(),array_chunk(),
