...
if(isset($_POST['submit'])){
  ...
  if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    $user = $db->add($pdo,$username,$salary,$city,$password,$email);

    if($user == 1){
      $_SESSION['message'] = 'User Successfully Register';
                ...
                <form class="mx-1 mx-md-4" method="post" action="">                
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <input type="text" name="salary" id="form3Example3c" class="form-control" placeholder="Salary" />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    <i class="fas fa-envelope fa-lg me-3 fa-fw"></i>
                    <div class="form-outline flex-fill mb-0">
                      <input type="text" name="city" id="form3Example3c" class="form-control" placeholder="City"
                      />
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      ...
                      <input type="text" name="email" id="form3Example3c" class="form-control" placeholder="Email" />
